  ...
  return (
    <>
      <div className="p-4 bg-gray-100 flex  items-center">
        <span className="text-xl">Home / Đơn hàng</span>
      </div>
        ...
        <table className="border-collapse border border-gray-400 bg-white w-full">
          <thead>
            <tr className="text-left">
              ...
              <th className="border border-gray-300">Ngày đặt</th>
              <th className="border border-gray-300">Mã đơn hàng</th>
              <th className="border border-gray-300 w-36">Khách hàng</th>
              <th className="border border-gray-300 w-36">Mã vận dơn</th>
              <th className="border border-gray-300 w-42">Giao hàng</th>
              <th className="border border-gray-300 w-30">Thanh toán</th>
              <th className="border border-gray-300 w-30">COD</th>
              <th className="border border-gray-300">Tổng tiền</th>
              <th className="border border-gray-300">Lời nhắn</th>
              <th className="border border-gray-300">Nguồn</th>
            </tr>
          </thead>
          <tbody>
            <tr>
